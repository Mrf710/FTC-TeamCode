...
## Welcome!
This GitHub repository contains the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot. To use this SDK, clone this entire project to your local computer using [GitHub Desktop](https://desktop.github.com/).

## Downloading the Project
If you are an Android Studio programmer, there are several ways to download this repo.

* If you are a git user, first fork the project and then [open the project using GitHub Desktop](x-github-client://openRepo/https://github.com/1595Dragons/FTC-7935)

Once you have downloaded your folder, you can use Android Studio to import the folder  ("Import project (Eclipse ADT, Gradle, etc.)").
